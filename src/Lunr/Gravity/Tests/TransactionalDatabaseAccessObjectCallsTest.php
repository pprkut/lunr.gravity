...
class TransactionalDatabaseAccessObjectCallsTest extends LunrBaseTest
{
     ...
     * @var \Lunr\Gravity\DatabaseConnection
     */
    protected $db;
    ...
    public function setUp(): void
    {
        ...
        $this->class = $this->getMockBuilder('Lunr\Gravity\TransactionalDatabaseAccessObject')
                            ->setConstructorArgs([ $this->db, $this->logger ])
                            ->getMockForAbstractClass();

        $this->reflection = new ReflectionClass('Lunr\Gravity\TransactionalDatabaseAccessObject');
    }
     ...
     *
     * @covers \Lunr\Gravity\TransactionalDatabaseAccessObject::begin_transaction
     */
     ...
     *
     * @covers \Lunr\Gravity\TransactionalDatabaseAccessObject::rollback_transaction
     */
     ...
     *
     * @covers \Lunr\Gravity\TransactionalDatabaseAccessObject::commit_transaction
     */
     ...
     *
     * @covers \Lunr\Gravity\TransactionalDatabaseAccessObject::end_transaction
     */
