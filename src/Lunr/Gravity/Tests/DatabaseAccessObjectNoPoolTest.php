...
class DatabaseAccessObjectNoPoolTest extends DatabaseAccessObjectTest
{
    ...
    public function testQueryEscaperIsStored(): void
    {
        ...
        $this->assertInstanceOf('Lunr\Gravity\DatabaseQueryEscaper', $property->getValue($this->class));
    }
     ...
     *
     * @covers Lunr\Gravity\DatabaseAccessObject::swap_connection
     */
    public function testSwapConnectionSwapsConnection(): void
    {
        $db = $this->getMockBuilder('Lunr\Gravity\MySQL\MySQLConnection')
    ...
    public function testSwapConnectionSwapsQueryEscaper(): void
    {
        ...
        $this->assertInstanceOf('Lunr\Gravity\DatabaseQueryEscaper', $new);
    }
